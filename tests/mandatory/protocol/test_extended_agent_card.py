...
- agent/getAuthenticatedExtendedCard endpoint MUST be available when declared
...
def get_extended_card_url(base_url: str) -> str:
    ...
    Per Section 7.10: The endpoint URL is {AgentCard.url}/../agent/getAuthenticatedExtendedCard
    ...
    if base_path:
        ...
        extended_path = f"{parent_path}/agent/getAuthenticatedExtendedCard"
    else:
        extended_path = "/agent/getAuthenticatedExtendedCard"
